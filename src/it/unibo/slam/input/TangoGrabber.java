 ...
 */
public class TangoGrabber implements SensorGrabberBGRD, PreviewCallback
{
	/**
	 ...
	 */
	public TangoGrabber(WriteOnlyDoubleBuffer<DataBGRD> doubleBufferBGRD)
	{
	...
	public DataBGRD grab() throws Exception
	{
		...
		boolean res = getFrame(timestamp, bgrPixels, frame);
	...
	private native boolean getFrame(double[] timestamp, byte[] bgrFrame, float[] depthFrame);
}
