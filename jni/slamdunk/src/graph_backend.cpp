...
#define  LOG_TAG5	"slamdunk_app"
#define  LOGI5(...)	__android_log_print(ANDROID_LOG_INFO, LOG_TAG5, __VA_ARGS__)

#include <g2o/core/block_solver.h>
//#include <g2o/core/optimization_algorithm_levenberg.h>
#include <g2o/optimization_algorithm_levenberg.h>
//#include <g2o/solvers/cholmod/linear_solver_cholmod.h>
//#include <g2o/solvers/pcg/linear_solver_pcg.h>
//#include <g2o/solvers/csparse/linear_solver_csparse.h>
#include <g2o/linear_solver_pcg.h>
  ...
  : m_optimizer(), m_action(&m_optimizer, 1e-10), m_edge_weights(0.)
{
  ...
  // PCG solver
  BlockSolver_6_0::LinearSolverType* linearSolver = new g2o::LinearSolverPCGMOD<BlockSolver_6_0::PoseMatrixType>();
  //BlockSolver_6_0::LinearSolverType* linearSolver = new g2o::LinearSolverCSparse<BlockSolver_6_0::PoseMatrixType>();

  BlockSolver_6_0* solver_ptr = new BlockSolver_6_0(linearSolver);
  g2o::OptimizationAlgorithmLevenbergMOD* opt_alg = new g2o::OptimizationAlgorithmLevenbergMOD(solver_ptr);
                                              ...
                                              g2o::HyperGraph::VertexSet* vSetPtr, g2o::HyperGraph::VertexSet* fSetPtr)
{
  ...
  std::stringstream ss;
  ss << "NUM OPT VERT: " << vset->size();
  LOGI5("%s", ss.str().data());

  m_action.reset();
  bool res = m_optimizer.initializeOptimization(*vset, -1);
